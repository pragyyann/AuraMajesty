...
export default function ServicesHero() {
  ...
  return (
    <section className="relative bg-dark-section text-surface-soft pt-32 pb-20 md:pt-40 md:pb-28 overflow-hidden">
      ...
      <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-[500px] h-[500px] bg-[#C7A56A]/5 rounded-full blur-3xl -z-10" />

      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
        <div className="max-w-3xl mx-auto space-y-6">
          {/* Eyebrow */}
          <span className="font-sans text-xs font-bold text-[#D8B878] uppercase tracking-widest block">
            The Menu
          </span>
          ...
          <div className="w-16 h-[1px] bg-[#C7A56A]/30 mx-auto" />
          ...
          <div className="pt-4">
            <button
              ...
              className="bg-[#141414] border border-white/25 hover:bg-[#C7A56A] hover:border-[#C7A56A] text-white font-sans text-xs font-bold px-8 py-4 tracking-wider uppercase transition-all duration-200 hover:-translate-y-[1px] inline-flex items-center space-x-2 cursor-pointer rounded-[16px]"
            >
